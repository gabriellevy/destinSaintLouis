init -5 python:
    ...
    def AjouterEvtsFamille():
        ...
        majoClodomir = dec_histo.DecHistoU(proba.Proba(0.3, True), "majoClodomir", 508) # 495 naissance + 13
        selecteur_.ajouterDeclencheur(majoClodomir)
        # majorité de Childebert
        majoChildebert = dec_histo.DecHistoU(proba.Proba(0.3, True), "majoChildebert", 510) # 497 naissance + 13
        selecteur_.ajouterDeclencheur(majoChildebert)
        # majorité de Clotaire
        majoClotaire = dec_histo.DecHistoU(proba.Proba(0.3, True), "majoClotaire", 511) # 498 naissance + 13
